...
/**
 * @brief  Gets the sensor_adafruit_t object describing the AHTx0's humidity sensor
 *
 * @param sensor The sensor_adafruit_t object to be populated
 */
void Adafruit_AHTX0_Humidity::getSensor(sensor_adafruit_t *sensor) {
...
/**
 * @brief  Gets the sensor_adafruit_t object describing the AHTx0's tenperature sensor
 *
 * @param sensor The sensor_adafruit_t object to be populated
 */
void Adafruit_AHTX0_Temp::getSensor(sensor_adafruit_t *sensor) {
  /* Clear the sensor_adafruit_t object */
  memset(sensor, 0, sizeof(sensor_adafruit_t));
